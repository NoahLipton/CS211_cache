...
#                print "result file is " + resultfile
            ...
            if resultfile[len(resultfile)-5] == "1" :
                ...
                try:
                    run_command("./%s 512 4 fifo assoc:2 %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    os.chdir(prevdir)
                    print "myScore is ", myscore
                ...
                try:
                    run_command("./%s 16 1 fifo assoc:2 %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    os.chdir(prevdir)
                    print "myScore is ", myscore
                ...
                try:
                    run_command("./%s 10 1 fifo assoc:2 %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    os.chdir(prevdir)
                    print "myScore is ", myscore
                ...
                try:
                    run_command("./%s 512 2 lru assoc %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    os.chdir(prevdir)
                    print "myScore is ", myscore
                ...
                try:
                    run_command("./%s 512 4 lru assoc:8 %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    os.chdir(prevdir)
                    print "myScore is ", myscore
                ...
                try:
                    run_command("./%s 1024 2 lru assoc:16 %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    os.chdir(prevdir)
                    print "myScore is ", myscore
            ...
            if os.system(command)==0:
                ...
                if (resultfile[0] != "o" and (resultfile[len(resultfile)-5] == "7" or resultfile[len(resultfile)-5] == "8" or resultfile[len(resultfile)-5] == "9" or  resultfile[len(resultfile)-5] == "a")):
                    myscore = myscore + 1.6666
                elif (resultfile[len(resultfile)-5] == "c") : 
                    myscore = myscore + 2.25
                elif (resultfile[0] == "o" and (resultfile[len(resultfile)-5] == "7" or resultfile[len(resultfile)-5] == "8" or resultfile[len(resultfile)-5] == "9" or  resultfile[len(resultfile)-5] == "a")) : 
                    myscore = myscore  
                else:
...
def single_grade(dirname):
    ...
    command = "diff -B" + output_dir + "/" +resultfile + " " + resultfile + " >/dev/null"
    if os.system(command)==0:
        print resultfile + " is correct"
        myscore = myscore + 5
    else:
